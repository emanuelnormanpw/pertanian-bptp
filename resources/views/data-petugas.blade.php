    ...
    <div class="mysidebar" style="font-size: 16px;">
        ...
        <div class="sidebar-custom" id="sidebar">
            <div class="list-group pt-5">
                ...
                <a href="{{route('data-petugas')}}" class="list-group-item list-group-item-action list-group-custom active">Data Petugas</a>
            </div>
        </div>
    </div>
        ...
        <header class="home-aboutus mb-auto" style="border-bottom: 4px solid #1dc293; font-size: 16px;">
            <div class="d-flex justify-content-center">
                <div class="navigasi container d-flex align-items-center justify-content-between">
                    ...
                    <a href="#" id="menu-button-sidebar"><img src="{{ URL::asset('assets/images/menu.png')}}" height="20px" alt="" srcset=""></a>
                    <nav class="nav nav-masthead justify-content-center float-md-end">
                        ...
                        <a class="nav-link active" href="{{route('data-petugas')}}">Data Petugas</a>
                    </nav>
                </div>
            </div>
                                        ...
                                        <div class="table-rep-plugin">
                                            <div class="table-responsive b-0" data-pattern="priority-columns">
                                                <table id="tech-companies-1" class="table table-striped">
                                                    <thead>
                                                        <tr>
                                                            <th width="33.33%" class="align-middle">NAMA</th>
                                                            <th width="33.33%" class="align-middle">NIK</th>
                                                            <th width="33.33%" class="align-middle">JABATAN</th>
                                                    </thead>
                                                    <tbody>
                                                        <?php for($i=1;$i<=5;$i++):?>
                                                        <tr>
